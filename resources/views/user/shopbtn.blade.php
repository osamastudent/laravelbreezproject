...
<html lang="en">
   ...
   <body>
      ...
      <div class="header_section mb-5 pb-5">
...
<a href="{{url('/')}}" class="btn btn-primary  h-100 w-50 offset-2" style="padding: 50px;
border-top-left-radius: 25px; border-top-right-radius: 25px;
border-bottom-left-radius: 25px;
border-bottom-right-radius: 25px; font-size:35px;
